...
public class DataBase extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("INSERT INTO user (id, name, phone, email, accountNumber, password)  VALUES (1032494428, 'David Pineda', 3166226220,'cdpinedao@gmail.com','1235-4654-3213-6548', 123456);");
        ...
        db.execSQL("INSERT INTO account (account, amount, state)  VALUES ('1235-4654-3213-6548', '100000', 'Activada');");
